...
abstract class RTCVideo {
  ...
  /// + RTC SDK 支持硬件耳返和软件耳返。一般来说，硬件耳返延时低且音质好。
  /// + 你的应用是否能够使用硬件耳返视手机厂商而定。蓝牙耳机不支持硬件耳返。iOS 平台仅支持软件耳返功能。
  /// + 使用华为手机硬件耳返功能时，请添加[华为硬件耳返的依赖配置](https://www.volcengine.com/docs/6348/113523)。
