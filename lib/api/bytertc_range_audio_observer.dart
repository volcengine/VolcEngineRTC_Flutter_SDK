...
class RTCRangeAudioObserver {
  /// 关于当前范围语音衰减系数的回调
  ///
  /// 手动订阅的场景下，房间内任一用户调用 updatePosition{@link #IRangeAudio#updatePosition} 更新自身位置或调用 [RTCRangeAudio.updateReceiveRange] 更新语音接收范围时，该用户与房间内其他用户的相对距离都会发生改变，据此计算的衰减系数也会发生改变，并通过该回调通知用户。 <br>
